...
function frameInit(){
	...
	viewport = new Ext.Viewport({
        ...
        new Ext.BoxComponent({
            ...
            autoEl: {
                tag: 'div',
                html:'<table border="0" width="98%"> <td align="left" valign="middle"><font size="4px">当前登录用户:'+username+'   所属单位:'+institution+'</font></td><td align="right" valign="middle"><a onclick="window.location.href=\'/SecrecySystem/Logout.do\'" style=\"cursor:pointer;\"><font size="4px">注销</font></a></td></table>'
            }
        }), {
            region: 'west',
